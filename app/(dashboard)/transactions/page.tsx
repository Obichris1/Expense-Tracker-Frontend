...
const dialogSlotProps = {
  paper: {
    sx: {
      // ── Fix: keep the dialog inside the viewport on mobile ──
      borderRadius: "16px",
      padding: 0,
      overflow: "hidden",
...
export default function TransactionsActivity() {
  ...
  const columns: ColumnDef<Transaction>[] = [
    ...
    },
    {
      ...
      // ── Fix: expense amounts should be red, income green (using CurrencyText for consistency) ──
      cell: ({ row }) => {
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-8 py-6 sm:py-8">
      ...
      <div className="mb-5 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-lg bg-gray-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-gray-700 transition-colors w-full sm:w-auto"
        >
      ...
      <div className="mb-4 flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="flex flex-wrap items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-500">
          ...
          <input
            ...
            className="border-0 outline-none text-gray-700 bg-transparent text-xs sm:text-sm min-w-0"
          />
        ...
        <button className="hidden sm:flex ml-auto items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors">
...
function PaymentDialog({ open, onClose, onSubmit, isSubmitting, accounts }: PaymentDialogProps) {
  ...
  return (
    ...
    >
      <DialogTitle sx={{
        padding: { xs: "20px 20px 12px", sm: "24px 28px 16px" },
      ...
      <DialogContent sx={{
        padding: { xs: "16px 20px 20px", sm: "20px 28px 28px" },
        overflowY: "auto",
      }}>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Amount + Account — stack on mobile, side by side on tablet+ */}
